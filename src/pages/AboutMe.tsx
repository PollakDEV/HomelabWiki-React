      ...
      <section id="terminal-section">
        <div className={`${styles['terminal-header']}`}>
          <div className={`${styles['terminal-buttons']}`}>
            <div className={`${styles['terminal-button-close']}`} />
            <div className={`${styles['terminal-button-minimize']}`} />
            <div className={`${styles['terminal-button-expand']}`} />
          </div>
        </div>
      ...
      <section id="content-section" style={{ display: 'none' }}>
        ...
        <section className={`${styles['projects-section']}`}>
          ...
          <div className={`${styles['project-grid']}`}>
            {[1, 2].map((item) => (
              <article key={item} className={`${styles['project-card']}`}>
                ...
                <div className={`${styles['project-info']}`}>
                  ...
                  <div className={`${styles['tech-stack']}`}>
                    {['Python', 'TensorFlow', 'React'].map((tech) => (
                      <span key={tech} className={`${styles['tech-tag']}`}>{tech}</span>
                    ))}
                  </div>
                  <div className={`${styles['project-links']}`}>
                    <a href="#" className={`${styles['link-button demo']}`}>
                      Live Demo
                      <div className={`${styles['link-trail']}`} />
                    </a>
                  </div>
                </div>
              </article>
        ...
        <div className={`${styles['contact-section']}`}>
          ...
          <div className={`${styles['contact-grid']}`}>
            <div className={`${styles['contact-card']}`} data-type="github">
              ...
              <a href="https://github.com/PollakDEV" target="_blank" rel="noopener noreferrer" className={`${styles['card-link']}`}>
                Connect <span>→</span>
              </a>
            </div>

            <div className={`${styles['contact-card']}`} data-type="email">
              <div className={`${styles['card-icon']}`}>
              ...
              <a href="mailto:owner@homelabwiki.pl" className={`${styles['card-link']}`}>
            ...
            <form className={`${styles['contact-form']}`}>
              ...
              <button type="submit" className={`${styles['glow-button']}`}>
                Transmit Data
                <div className={`${styles['button-pulse']}`} />
              </button>
            </form>
          </div>
        </div>
